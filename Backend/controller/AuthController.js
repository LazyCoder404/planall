...
exports.login = async(req,res) => {
    ...
    if(role === 'admin'){
        ...
        if(check_Admin){
            ...
            res.json(Response.ResponseDataMsg("Admin Login SuccessFully", {token:token,role:"admin"}))
            return
        }else{
        ...
        if(check_Teacher){
            ...
            res.json(Response.ResponseDataMsg("Teacher Login SuccessFully", {token:token,role:"teacher"}))
            return
        }else{
            res.json(Response.RequiredErrors('incorrect Credential'))
            return 
        ...
        if(check_Teacher){
            const token = await check_Teacher.gettoken()
            res.json(Response.ResponseDataMsg("Student Login SuccessFully", {token:token,role:"student"}))
            return
        }else{
            res.json(Response.RequiredErrors('incorrect Credential'))
            return 
