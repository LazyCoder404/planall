    ...
    const deleteUser = async (id) => {
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                const delCategory = await API.post(`/student/delete/${id}`,)
        ...
        <>
            <Layout sidebar={true}>
                <div className="page-heading">
                    <h3 className="my-1">Student Details</h3>
